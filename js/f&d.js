...
function setComida() {
    ...
    codeComida += '<form class="form-inline" action="#" method="post">';
    codeComida += '<div class="form-group">';
    codeComida += '<select class="form-control">';
    ...
    codeComida += '<input type="date" class="form-control" id="checkin" placeholder="Check-In" value"Chek-In">';
    codeComida += '</div>';
    codeComida += '<div class="form-group">';
    codeComida += '<select class="form-control">';
